        ...
        if (user?.role === 'pro') {
            const fetchHistory = async () => {
                try {
                    ...
                    // Sort by date descending, assuming createdAt is a Firebase Timestamp
                    historyData.sort((a, b) => b.createdAt.toDate() - a.createdAt.toDate());
                        ...
                        <div className="space-y-4">
                            {history.map(item => (
                                <div key={item.id} className="border p-4 rounded-md">
                                    ...
                                    <p className="text-sm text-gray-500">Gaya: {item.videoStyle} | Dibuat pada: {new Date(item.createdAt.seconds * 1000).toLocaleDateString()}</p>
